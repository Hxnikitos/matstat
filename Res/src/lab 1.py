...
def normal_distribution():
    for size in sizes:
        ...
        plt.grid()
        plt.show()
        fig.savefig('D:\VUZ\3 kurs\6 sem\MathStat/Res' +'Normal distribution ' + str(size) +".png")
...
def cauchy_distribution():
    for size in sizes:
        ...
        plt.grid()
        plt.show()
        fig.savefig('D:\VUZ\3 kurs\6 sem\MathStat/Res' +'Cauchy distribution ' + str(size) +".png")
    return
...
def poisson_distribution():
    for size in sizes:
        ...
        plt.show()
        fig.savefig('D:\VUZ\3 kurs\6 sem\MathStat/Res' +'Poisson distribution ' + str(size) +".png")
    return
...
def uniform_distribution():
    for size in sizes:
        ...
        plt.grid()
        plt.show()
        fig.savefig('D:\VUZ\3 kurs\6 sem\MathStat/Res' +'Uniform distribution ' + str(size) +".png")
    return
